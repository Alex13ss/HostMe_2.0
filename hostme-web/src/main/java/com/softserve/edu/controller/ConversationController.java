...
public class ConversationController {
    ...
    public String conversationsIndex(@RequestParam("group_id") long id,
            ModelMap model) {
        List<ConversationDto> conversations = conversationService
                .findAllConversationsDtoByGroupId(id);
    ...
    /**
     * Creates a new instance of conversation from request and persists it to
     * the database
     * 
     * @param conversation
     *            Conversation from request
     * @param model
    ...
    public String createConversation(
        ...
        String msg = "Created new conversation";
        notificationService.addNotification(conversation.getGroup(), msg);
