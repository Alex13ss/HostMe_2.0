					...
					<div class="box-body">
						<div id="carousel-example-generic" class="carousel slide"
							...
							<div class="carousel-inner">
								<div class="item">
									<img src="resources/images/index-hosting1.jpg"
										alt="First slide">
								...
								<div class="item">
									<img src="resources/images/index-hosting3.jpg"
										alt="Third slide">
									...
									<div class="form-group">
										<div>
											<form:input path="email" type="text" class="form-control"
												id="email" placeholder="email.example@email.com"
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<c:if test="${param.success eq true }">
								<div class="row">
									<div class="callout callout-info">Your account has been
										activated successfully! Congratulations! Now you need to log
										in!</div>
							...
							<c:if test="${param.error eq true }">
								<div class="callout callout-danger" id="alert">Wrong login
									or password! Try again!</div>
							</c:if>

							<c:if test="${param.registration eq true }">
								<div class="callout callout-warning" id="alert">We send
									you the mail with the activation link. Please, check your mail
									and activate your account!</div>
							</c:if>

							<c:if test="${param.logout eq true }">
								<div class="callout callout-danger" id="alert">You have
									logged out. Please, log in!</div>
							</c:if>
