...
public interface UserRepository extends
    ...
    public List<User> findAllByInterestingGroups(Group interestingGroups);

    public List<User> findByFirstNameContainingOrLastNameContainingOrLoginContainingAllIgnoreCase(
